const AVAILABLE_wordToGuessS = ['qualification', 'reactor', 'electricity', 'japan', 'breeze', 'sakura', 'broadcast', 'limitation', 'publicity'] //
...
function handleKeyboardButtonClick(letterContainer, char) {
    ...
    if (guessWordLetterIndex !== -1) {
        ...
        letterContainer.style.backgroundColor = 'yellowgreen'
        ...
        if (openLetterCounter === wordToGuess.length) {
            disableKeyboard()
            document.body.style.backgroundColor = '#C2EF68'
        }
    } else {
